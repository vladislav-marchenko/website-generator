...
export const Pricing = () => {
  ...
  const { ref, previousCard, nextCard } = useCardsAnimation(selectNextCardIndex)
  ...
  return (
    <Section className='flex items-center'>
      ...
      >
        <div className='flex flex-col gap-4 duration-700 repeat-1 group-data-[animation]:animate-fade-out-down-fade-in-up'>
          <h2>{title}</h2>
